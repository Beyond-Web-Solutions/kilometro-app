...
export const lightTheme: MD3Theme = {
  ...MD3LightTheme,
  colors: {
    primary: "rgb(1, 110, 45)",
    onPrimary: "rgb(255, 255, 255)",
    primaryContainer: "rgb(154, 247, 166)",
    ...
    inversePrimary: "rgb(127, 218, 140)",
    elevation: {
      level0: "transparent",
...
export const darkTheme: MD3Theme = {
  ...MD3DarkTheme,
  colors: {
    primary: "rgb(127, 218, 140)",
    onPrimary: "rgb(0, 57, 20)",
    primaryContainer: "rgb(0, 83, 32)",
    onPrimaryContainer: "rgb(154, 247, 166)",
